...
OPENAI_API_KEY = st.sidebar.text_input(
    "OpenAI API Key", 
    value="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",
    type="password"
)
GEMINI_API_KEY = st.sidebar.text_input(
    "Gemini API Key", 
    value="AIzaSyBmhOAnYsK0Ue19WgX35mehJzvczrNzS5A",
    type="password"
)
CLAUDE_API_KEY = st.sidebar.text_input(
    "Claude API Key", 
    value="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",
    type="password"
)
...
# Update the process_workflow function to use the workflow steps
